...
import copy
from rscd.models.decoderheads.YTYAttention import *
...
def window_partition(x, window_size):
    ...
    if pad_h > 0 or pad_w > 0:
        x = F.pad(x, (0, 0, 0, pad_w, 0, pad_h))  # Pad on H and W dimensions
        H += pad_h
        W += pad_w
...
class SwinTransformerBlock(nn.Module):
    ...
    def forward(self, x, H, W):
        ...
        # reverse windows and remove padding
...
class PatchEmbed(nn.Module):
    ...
    def forward(self, x):
        ...
        self.patches_resolution = [H // self.patch_size[0], W // self.patch_size[1]]
...
class encoder1(nn.Module):
    def __init__(self):
        ...
        self.encoder1 = SwinTransEncoder(img_size=224, patch_size=4, in_chans=3, num_classes=2, embed_dim=128,
                                         ...
                                         window_size=7)
        self.pretrained_path = 'rscd/models/decoderheads/swin_base_patch4_window7_224_22kto1k.pth'
        self.load_from()
