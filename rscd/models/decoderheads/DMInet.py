...
from rscd.models.decoderheads import resnet
...
from rscd.models.decoderheads.resnet_dminet import resnet18
...
class DMINet(nn.Module):
    def __init__(self, num_classes=2, drop_rate=0.2, normal_init=True, pretrained=False, show_Feature_Maps=False):
        ...
        #self.resnet.load_state_dict(torch.load('./pretrain_model/resnet18-5c106cde.pth'))
