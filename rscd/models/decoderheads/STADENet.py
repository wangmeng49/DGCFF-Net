...
from rscd.models.stadenet.help_funcs import Transformer, TransformerDecoder, TwoLayerConv2d
from rscd.models.stadenet.ChangeFormer import ChangeFormerV1, ChangeFormerV2, ChangeFormerV3, ChangeFormerV4, ChangeFormerV5, \
    ChangeFormerV6
from rscd.models.stadenet.SiamUnet_diff import SiamUnet_diff
from rscd.models.stadenet.SiamUnet_conc import SiamUnet_conc
from rscd.models.stadenet.Unet import Unet
from rscd.models.stadenet.DTCDSCN import CDNet34
...
class BASE_Transformer(ResNet):
    ...
    def zl_difference(self, x):
        ...
        _c1_24 = np.transpose(_c1_24, (1, 2, 3, 0)).cuda()
        nn.Sigmoid(),
        ...
        # 2 step
        # 2.1 step
        conv3_LZ = nn.Conv3d(_c1_25_M_1J.shape[0], _c1_25_M_1J.shape[0], kernel_size=3, padding=1, groups=1, stride=1,
                             bias=False).cuda()
        _c1_26_M_1J = conv3_LZ(_c1_25_M_1J)
        nn.Sigmoid(),
        # 2.2 step
        conv3_LZ = nn.Conv3d(_c1_26_M_1J.shape[0], _c1_25_M_1J.shape[0], kernel_size=3, padding=1, groups=1, stride=1,
                             bias=False).cuda()
    ...
    def forward(self, x1, x2):
        ...
        # TMM
        model = Rnn(x_size, y_size, 2, 2, help="x_size and y_size are the pixel size your set, my pixel size[32, 32]")
        model = model.cuda()
        # Maxpooling
